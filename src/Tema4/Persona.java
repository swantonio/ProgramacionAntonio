...
public class Persona {
    ...
    public void imprimirValidezDNI() {
        if (checkDNI(this.dni)) {
            System.out.println("El DNI (" + dni + ") de " + nombre + " es valido.");
        } else {
            System.out.println("El DNI (" + dni + ") de " + nombre + " es falso.");
        }
    }
}
